<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul class="navigation-left">
             ...
             <li class="nav-item  @if(basename($_SERVER['REQUEST_URI'])=='dashboard') active @endif" >
              ...
              <li class="nav-item  @if(basename($_SERVER['REQUEST_URI'])=='prospects') active @endif" >
                <a class="nav-item-hold" href="{{url('prospects')}}">
            ...
            <li class="nav-item d-none  @if(basename($_SERVER['REQUEST_URI'])=='exhibitor') active @endif" >
                <a class="nav-item-hold" href="{{url('exhibitor')}}">
                    <i class="nav-icon i-Administrator"></i>
                    <span class="nav-text">Manage Exhibitors</span>
                </a>
                <div class="triangle"></div>
            </li>
            <li class="nav-item @if(basename($_SERVER['REQUEST_URI'])=='templates') active @endif" >
                <a class="nav-item-hold" href="{{route('templates')}}">
                    <i class="nav-icon i-Administrator"></i>
          ...
          <li class="nav-item d-none @if(basename($_SERVER['REQUEST_URI'])=='Campaign') active @endif " data-item="campaign">
                <a class="nav-item-hold" href="{{url('Campaign')}}">
  ...
  <ul class="childNav" data-parent="campaign">
            <li class="nav-item">
                <a class="{{ Route::currentRouteName()=='echarts' ? 'open' : '' }}" href="{{url('Campaign')}}">
                    <i class="nav-icon i-File-Clipboard-Text--Image"></i>
