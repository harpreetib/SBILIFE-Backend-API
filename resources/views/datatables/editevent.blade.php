        ...
        <div class="card mb-4">
            <div class="card-body">              
                   <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="ex_nickname" id="ex_nickname" placeholder="NickName" 
                             value="{{$eventlist->aem_event_nickname}}" readonly/>
              ...
              <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="ex_address" id="ex_address"  placeholder="Address"
                             value="{{$eventlist->aem_full_address}}">
                        ...
                        <div class="col-md-6 form-group mb-3">
                              <label for="e_livedt">Live Date Time <span style="color:red;"><sup>Change this to make event live</sup></span></label>                        
                                  <input id="e_livedt" type="text" step=1 class="form-control" name="ex_livedt" placeholder="Live Date Time"  value="{{$eventlist->aem_live_date_time}}">
                          ...
                          <div class="col-md-6 form-group mb-3">
                              <label for="picker3">Start Date Time <span style="color:red">*</span></label>                        
                                  <input id="e_startdates" type="text" step=1 class="form-control" name="ex_startdates" placeholder="Start Date Time"  value="{{$eventlist->aem_start_date}}">
                                 <div class="input-group-append">                                      
                              </div>
                              <span class="text-danger" id="msg_start" name="lccc_start"  style="display:none;"></span>
                          </div>
              ...
              <div class="col-md-6 form-group mb-3">
                              <label for="picker3">End Date Time <span style="color:red">*</span></label>                        
                                  <input id="ex_enddate" type="text" step=1 class="form-control" name="e_enddate" placeholder="End Date Time"   value="{{$eventlist->aem_end_date}}">
                             ...
                             <div class="col-md-6 form-group mb-3">
                                <label for="course_fee_sem">Select Day</label>  
                                 <select class="form-control" id="ex_day" name="ex_day">
                                  <option value="{{$eventlist->aem_day}}">{{$eventlist->aem_day}}</option>         
                                ...
                                <span class="text-danger" id="msg_day" name="err_day"  style="display:none;"></span>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ex_eventdate" id="ex_eventdate" step=1 placeholder=" Event Date" 
                                         value="{{$eventlist->aem_event_date}}">
                                     ...
                                     <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select class="form-control" name="ex_timezones" id="ex_timezones">
                                            @foreach($Allcountry as $country)
                                             <option value="{{$country->timezones}}" data-id="{{$country->counm_code}}" {{ $country->timezones == $eventlist->aem_timezones ? 'selected' : ''  }}>{{$country->counm_name}}</option>
                                            @endforeach
                                        </select>
                                      </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ex_subject" id="ex_subject" placeholder="Subject" 
                                         value="{{$eventlist->aem_mail_subject}}">
                                ...
                                <label for="course_fee_sem">Status</label>
                  				<select class="custom-select" name="status" id="status">                            
                                    @if($eventlist->aem_status =='future')
                                    <option value="{{$eventlist->aem_status}}">{{ucfirst($eventlist->aem_status)}}</option>
                                    <option value="current">Current</option>
                                    <option value="old">Finish</option>  
                                    <option value="inactivate">Inactivate</option> 
                                    @endif
                                    @if($eventlist->aem_status =='current')
                                    <option value="{{$eventlist->aem_status}}">{{ucfirst($eventlist->aem_status)}}</option>
                                    <option value="future">Future</option>
                                    <option value="old">Finish</option>  
                                    <option value="inactivate">Inactivate</option> 
                                    @endif
                                    @if($eventlist->aem_status =='old')
                                    <option value="{{$eventlist->aem_status}}">Finish</option>
                                    <option value="future">Future</option>
                                    <option value="current">Current</option>  
                                    <option value="inactivate">Inactivate</option>
                                    @endif
                                    @if($eventlist->aem_status =='inactivate')
                                     <option value="{{$eventlist->aem_status}}">{{ucfirst($eventlist->aem_status)}}</option>
                                    <option value="future">Future</option>
                                    <option value="current">Current</option>  
                                    <option value="old">Finish</option>
                                 ...
                                 <span class="text-danger" id="msg_status" name="err_status"  style="display:none;"></span>
                                     ...
                                     <div class="col-md-12 form-group mb-3">
                                        <label for="course_fee_sem">Event Mail</label>
                                         ...
                                         <textarea class="ckeditor form-control form-control-lg"  name="ex_eventmail" autocomplete="off" id="ex_mail" >{{$eventlist->aem_mail_html}}</textarea>
                                    ...
                                    <div class="col-md-12 form-group mb-3">
                                        <label for="course_fee_sem">SMS</label>
                                         ...
                                         <textarea class="ckeditor form-control form-control-lg"  name="ex_sms" autocomplete="off" id="ex_sms" >{{$eventlist->aem_sms_text}}</textarea>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input class="input-file uniform_on" name="ex_file" id="ex_file" type="file"><img src="{{URL::to($eventlist->aem_logo_image)}}" style="height: 89px; margin-left: 32px;width: 122px;">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input class="input-file uniform_on" name="he_image" id="he_image" type="file"><img src="{{URL::to($eventlist->aem_header_img)}}" style="height: 89px; margin-left: 32px;width: 122px;">
            ...
            <div class="modal-footer">
                 <input type="hidden" class="form-control" value="{{$eventlist->aem_id}}" name="aem_id" id="aem_id">
