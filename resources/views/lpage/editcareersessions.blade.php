		        ...
		        <div class="card-body">
		                ...
		                <div class="row">
		                    ...
		                    <div class="col-md-6 form-group mb-3">
		                        ...
		                        <!--value="{{$dataList->lccs_sub_title}}">-->
		                        <textarea class="form-control" name="e_sub_title" id="e_sub_title" placeholder="Sub Heading">{{$dataList->lccs_sub_title}}</textarea>
		                        <!--<span class="text-danger" id="lccc_name" name="lccc_name"  style="display:none;"></span>-->
		                    </div>
		                   ...
		                   <!--     value="{{$dataList->lccs_moderator_name}}">-->
		                   ...
		                   <!-- </div>-->
		                    ...
		                    <!--    value="{{$dataList->lccs_moderator_designation}}">-->
		                    ...
		                    <!--    value="{{$dataList->lccs_moderator_desc}}">-->
		                        <!--<span class="text-danger" id="lcc_sname" name="lcc_sname"  style="display:none;"></span>-->
		                    <!--</div>-->
		                    ...
		                    <!--    value="{{$dataList->lccs_host_designation}}">-->
		                        <!--<span class="text-danger" id="lcc_sname" name="lcc_sname"  style="display:none;"></span>-->
		                    <!--</div>-->
		                    <!-- <div class="col-md-6 form-group mb-3">-->
		                    ...
		                    <div class="col-md-6 form-group mb-3">
	                            <label for="picker3">Start Date Time</label>                        
	                                <input id="e_startdates" type="datetime-local" step=1 class="form-control" name="e_startdates" placeholder="Start Date Time"  value="{{  date("Y-m-d\TH:i:s", strtotime($dataList->lccs_start_datewtime)) }}">
		                    ...
		                    <div class="col-md-6 form-group mb-3">
	                            <label for="picker3">End Date Time</label>                        
	                                <input id="e_enddate" type="datetime-local" step=1 class="form-control" name="e_enddate" placeholder="End Date Time"   value="{{ date("Y-m-d\TH:i:s", strtotime($dataList->lccs_end_datewtime)) }}">
	                               <div class="input-group-append">                                      
	                            </div>
        								...
        								<div class="col-md-6 float-right" >
            								...
            								<div class="">
            									<table class="table table-bordered table-striped">
            										...
            										<tbody id="nspeaker">
            											<?php $j=0;?>
            											@if(count($speaker_data)>0)
            											    @foreach($speaker_data as $speaker)
            											<tr>
            											    <td><input class="form-control" type="text" name="estime-<?php echo $j; ?>" autocomplete="off" id="estime-<?php echo $j; ?>" value="{{$speaker->lccss_time}}"   placeholder="Session Time"></td>
            											    <td><input class="form-control" type="text" name="escname-<?php echo $j; ?>" autocomplete="off" id="escname-<?php echo $j; ?>" value="{{$speaker->lccss_company_name}}"   placeholder="Compqny Name"></td>
            												<td><input class="form-control" type="text" name="esname-<?php echo $j; ?>" autocomplete="off" id="esname-<?php echo $j; ?>" value="{{$speaker->lccss_name}}"   placeholder="Full Name"></td>
            												<td><input class="form-control" type="text" name="esdesig-<?php echo $j; ?>" autocomplete="off" id="esdesig-<?php echo $j; ?>" value="{{$speaker->lccss_designation}}"   placeholder="Designation"></td>
            													<td><input class="form-control" type="text" name="esdesc-<?php echo $j; ?>" autocomplete="off" id="esdesc-<?php echo $j; ?>" value="{{$speaker->lccss_description}}"   placeholder="Description"></td>
            													<td><img style="width:50px;" src="{{asset($speaker->lccss_pic)}}"</td>
            												...
            												<td class="text-danger"><a class="fa fa-trash delete-rowe"></a>
            													...
            													<input type="hidden" name="lccss_id-<?php echo $j; ?>" value="{{$speaker->lccss_id}}"></td>
