                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="<?php echo e(asset('assets/images/faces/2.jpg')); ?>" alt="">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="<?php echo e(asset('assets/images/faces/3.jpg')); ?>" alt="">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center border-bottom-dotted-dim pb-3 mb-3">
                                <img class="avatar-md rounded mr-3" src="<?php echo e(asset('assets/images/faces/4.jpg')); ?>" alt="">
                                <div class="flex-grow-1">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/metagraha/public_html/induction/admin/resources/views/dashboard/dashboardv2.blade.php ENDPATH**/ ?>