...
class Create1ExhibitorBoothdesignMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('1_exhibitor_boothdesign_master', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('1_exhibitor_boothdesign_master');
    }
}
