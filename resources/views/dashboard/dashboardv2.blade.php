                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-primary text-24 line-height-1 m-0">{{$totalLead}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-primary text-24 line-height-1 m-0">{{$todayLead}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-primary text-24 line-height-1 m-0">{{$totalExhib}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon-big mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="line-height-1 text-title text-18 mt-2 mb-0">{{$totalTemp}}</p>
                                </div>
                            </div>
                        </div>
