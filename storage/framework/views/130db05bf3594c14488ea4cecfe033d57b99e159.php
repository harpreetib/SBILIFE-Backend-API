...
<?php $__env->startSection('main-content'); ?>
        ...
        <div class="breadcrumb">
                <h1>&nbsp;</h1>
                <ul>
                    <li><strong>Selfie Report </strong></li>
                    <li><a href="SelfieReport">List</a></li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="content">
                                <p class="text-muted mt-2 mb-0">Total Selfie Created</p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megaspace/public_html/admin/resources/views/customers/Reports/selfie_report.blade.php ENDPATH**/ ?>