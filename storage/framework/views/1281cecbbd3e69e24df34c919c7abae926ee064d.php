                       ...
                       <a id="eventDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="eventDropdown">
                            <?php if(basename($_SERVER['REQUEST_URI'])=='dashboard' || basename($_SERVER['REQUEST_URI'])=='all-leads'): ?>
                                    <?php if($profileDetail->at_id=='1' || $profileDetail->at_id=='2' || $profileDetail->at_id=='5'): ?>
            ...
            <div class="user col align-self-end">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    <div class="dropdown-header">
                        <i class="i-Lock-User mr-1"></i> <?php echo e($Asession->user_name); ?>

                    </div>
                    <a class="dropdown-item" href="settings"><i class="i-Gear spin mr-1"></i>Account settings</a>
                    <a class="dropdown-item" href="streammaster"><i class="i-Gear spin mr-1"></i>Manage Streams</a>
                     <?php if(!empty($selectedEvent)): ?>
                        <a class="dropdown-item" href="manage-intermediate-page"><i class="i-Gear spin mr-1"></i>Manage Intermediate Page</a>
                    <?php endif; ?>
...
<!-- header top menu end --><?php /**PATH /home/ibentosroot/public_html/events/admin/resources/views/layouts/large-vertical-sidebar/admin-header.blade.php ENDPATH**/ ?>