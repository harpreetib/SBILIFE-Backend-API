...
<div class="app-admin-wrap layout-sidebar-large clearfix">
    ...
    <?php endif; ?>
     ...
     <?php if(null!==request('brand') && $uType==null): ?>
    ...
    <?php if(null!==request('brand') && $uType!=null): ?>
        ...
        <?php echo $__env->make('layouts.large-vertical-sidebar.exhibitor-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    
        <!-- ============ end of header menu ============= -->
    
        <?php echo $__env->make('layouts.large-vertical-sidebar.exhibitor-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- ============ Large Sidebar Layout End ============= --><?php /**PATH /home/megaspace/public_html/sbilife/console/resources/views/layouts/large-vertical-sidebar/master.blade.php ENDPATH**/ ?>