...
<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item <?php if(basename($_SERVER['REQUEST_URI'])=='manageevents'): ?> active <?php endif; ?>">
            ...
            <li class="nav-item  <?php if(basename($_SERVER['REQUEST_URI'])=='exhibitor'): ?> active <?php endif; ?>" >
...
<!--=============== Left side End ================--><?php /**PATH /home/megaspace/public_html/admin/resources/views/layouts/large-vertical-sidebar/admin-sidebar.blade.php ENDPATH**/ ?>