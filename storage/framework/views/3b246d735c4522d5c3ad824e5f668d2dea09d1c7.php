...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="<?php echo e(asset('favicon.ico')); ?>?v3" sizes="32x32" />
        <link rel="icon" href="<?php echo e(asset('favicon.ico')); ?>?v3" sizes="192x192" />
    ...
    <body>
        <div class="auth-layout-wrap" style="background-image: url(<?php echo e(asset('assets/images/login-bg-new.jpg')); ?>)">
...
</html><?php /**PATH /home/megaspace/public_html/sbilife/console/resources/views/sessions/signIn.blade.php ENDPATH**/ ?>