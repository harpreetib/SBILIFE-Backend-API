                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $Alldata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($list->cd_email); ?>
                                                ...
                                                <div><?php echo e($list->cd_mobile); ?></div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <span class="text-primary">
                                                    <a href="https://lifeverse.megaspace.ai/<?php echo e($list->bm_nickname); ?>" title="View" target="_blank">
                                                        https://lifeverse.megaspace.ai/<?php echo e($list->bm_nickname); ?>
                                            ...
                                            <td>
                                                <?php if(!empty($list->bm_nickname)): ?>
                                                   <span class="text-primary">https://lifeverse.megaspace.ai/console/<?php echo e($list->bm_nickname); ?></span> 
                                                <?php endif; ?>
                                               <div><?php echo e($list->login_id); ?></div>
...
<?php /**PATH /home/megaspace/public_html/sbilife/console/resources/views/superadmin/table_content.blade.php ENDPATH**/ ?>