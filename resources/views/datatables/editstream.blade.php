		 ...
		 {{ csrf_field() }}
		    ...
		    <div class="card mb-4">
		                ...
		                <div class="row">
		                     ...
		                     <div class="col-md-6 form-group mb-3 d-none">
                                        ...
                                        <select class="form-control" name="mws_mode" id="mws_mode">
                                            <option value="live"  @if($dataList->mws_mode=='live') selected @endif >Live</option>
                                            <option value="gallery" @if($dataList->mws_mode=='gallery') selected @endif >Gallery</option>
                                        </select>
		                       ...
		                       <div class="col-md-6 form-group mb-3 ">
                                        ...
                                        <select class="form-control" name="mws_has_exhibition" id="mws_has_exhibition">
                                            <option value="Yes"  @if($dataList->mws_has_exhibition=='Yes') selected @endif >Yes</option>
                                            <option value="No" @if($dataList->mws_has_exhibition=='No') selected @endif >No</option>
                                        </select>
                                        <span class="text-danger" id="err_name" name="err_name"  style="display:none;"></span>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        value="{{$dataList->mws_exhibition_url}}" >
                                        <span class="text-danger" id="err_name" name="err_name"  style="display:none;"></span>
                                    </div>
		                            ...
		                            <div class="col-md-6 form-group mb-3">
                                        ...
                                        value="{{$dataList->mws_name}}" required>
                                        <span class="text-danger" id="err_name" name="err_name"  style="display:none;"></span>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mws_video_url" id="mws_video_url" placeholder="Vimeo url" 
                                         value="{{$dataList->mws_video_url}}" required>
                                     ...
                                     <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mws_youtube_url" id="mws_youtube_url" placeholder="Youtube embed url" 
                                         value="{{$dataList->mws_youtube_url}}">
                                     ...
                                     <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mws_facebook_url" id="mws_facebook_url" placeholder="Facebook embed url" 
                                         value="{{$dataList->mws_facebook_url}}">
                                     ...
                                     <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mws_webinar_finish_url" id="mws_webinar_finish_url" placeholder="Post Conference url" 
                                         value="{{$dataList->mws_webinar_finish_url}}">
                                    </div>
                                     ...
                                     <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="liveChatUrl" id="liveChatUrl" placeholder="Live Chat url" 
                                         value="{{$dataList->mws_live_chat_url}}" >
                                    ...
                                    <div class="col-md-12 form-group mb-3">
                                        ...
                                        <textarea  class="form-control" name="presentationVideoUrl" id="presentationVideoUrl" placeholder="Page Presentation Video Url">{{$dataList->mws_presentation_video}}</textarea> 
                                        <span class="text-danger" id="err_presentationVideoUrl"  style="display:none;"></span>
                                        
                                        @if(!empty($dataList->mws_presentation_video))
                                            <a href="{{$dataList->mws_presentation_video}}" target="_new">View Presentation Video</a>
                                        @endif
                                    </div>
                                     ...
                                     <div class="col-md-12 form-group mb-3">
                                        ...
                                        <input type="file" class="form-control" name="web_bgimage" id="ImageBrowse" placeholder="Image for Background" 
                                         value="">
                                        @if(!empty($dataList->mws_background_img))
                                        <br>
                                        <img height="100px" src="{{ URL::to('/') }}{{'/public/assets/images/'.Session('A_Session')->bm_id.'/conferencehall/'.$dataList->mws_background_img }}">
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-12 form-group mb-3 d-none">
                                        ...
                                        <textarea class="form-control" name="footer_wigets" id="footer_wigets" placeholder="Footer Wigets" style="height: 200px;">{{$dataList->mws_footer_wigets}}</textarea>
                                    ...
                                    <div class="col-md-12 form-group mb-3 d-none">
                                        ...
                                        <textarea class="form-control" name="mws_custom_css" id="mws_custom_css" placeholder="Custom" style="height: 200px;">{{$dataList->mws_custom_css}}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-group mb-3">
                                    	...
                                    	<div class="form-check">
                                    		<input class="form-check-input" type="radio" name="isDefault" id="isDefaultNo" value="N" @if($dataList->isDefault=='N') checked @endif>
                                    		<label class="form-check-label" for="isDefaultNo">
                                    			No
                                    		</label>
                                    	</div>
                                    	<div class="form-check">
                                    		<input class="form-check-input" type="radio" name="isDefault" id="isDefaultYes" value="Y" @if($dataList->isDefault=='Y') checked @endif>
		        ...
		        <div class="modal-footer">
		             <input type="hidden" class="form-control" value="{{$dataList->mws_id}}" name="mws_id" id="mws_id">
