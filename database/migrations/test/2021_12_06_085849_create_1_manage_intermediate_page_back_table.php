...
class Create1ManageIntermediatePageBackTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('1_manage_intermediate_page_back', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('1_manage_intermediate_page_back');
    }
}
