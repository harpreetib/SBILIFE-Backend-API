...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTitle-2"><h4>{{$setModelTitle}}</h4></h5>
...
{{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-12">
                    ...
                    <div class="mb-4 col-12">
                        ...
                        <span><input type="text" class="form-control"  name="organization_name" id="organization_name" value="{{$profileDetail->exhim_organization_name}}" /></span>
                    </div>
                    ...
                    <div class="mb-4  col-12 ">
                        ...
                        <span>
                            <select id="country" name="country"   data-id="country" class="form-control custom-select target" >
                                ...
                                @if(!empty($counm_code))
                                        @foreach($counm_code as $key => $counmdata)
                                                <option value="{{$counmdata->counm_id}}" @if(isset($profileDetail->counm_id) && $profileDetail->counm_id==$counmdata->counm_id) selected @endif > {{$counmdata->counm_name}} </option>
                                        @endforeach
                                @endif
                            </select>
                        </span>
        ...
        <div class="row">
                ...
                <div class="col-md-4 col-6">
                    ...
                    <div class="mb-4">
                        ...
                        <span><input type="text" class="form-control"  name="recognition" id="recognition" value="{{$profileDetail->exhim_recognition}}" /></span>
                    </div>
 ...
 <input class="form-control" type="hidden" name="quickfact" id="quickfact" value="quickfact" />
        <div class="row">
                ...
                <!--        <span><input type="text" class="form-control"  name="contact_person_incharge" id="contact_person_incharge" value="{{$profileDetail->contact_person_incharge}}" /></span>-->
                <!--    </div>-->
                <!--</div>-->
                ...
                <!--        <span><input type="text" class="form-control"  name="designation" id="designation" value="{{$profileDetail->exhim_designation}}" /></span>-->
                <!--    </div>-->
                <!--</div>-->
                ...
                <!--        <span class="row">-->
                <!--            <span class="col-2">-->
                <!--            <input type="number" class="form-control" placeholder="Country Code"  name="office_phone_code" id="office_phone_code" value="{{$profileDetail->office_phone_code}}" />-->
                <!--            </span>-->
                            
                <!--            <span class="col-10">-->
                <!--            <input type="text" class="form-control"  name="office_contact_number" id="office_contact_number" value="{{$profileDetail->office_contact_number}}" />-->
                <!--            </span>-->
                <!--            </span>-->
                <!--    </div>-->
                <!--</div>-->
                ...
                <!--        <span><input type="text" class="form-control"  name="fax_number" id="fax_number" value="{{$profileDetail->fax_number}}" /></span>-->
                <!--    </div>-->
                <!--</div>-->
                ...
                <div class="form-group col-md-6 col-6 my-multiselect">
                        <p class="text-primary mb-1">Industry</p>
                        	<select multiple class="custom-select form-control shadow-sm" name="industry[]" id="multiselect" data-text="Select your > Looking for or interested in: Industry">
                                ...
                                <option value="{{$industry->ot_id}}" @if(in_array($industry->ot_id, $industyArray)) selected @endif>{{$industry->ot_name}}</option> 
                                @endforeach    
                ...
                <div class="col-md-6 form-group mb-3" id="modal-content">
                    <label for="text-primary mb-1">Exhibitor Profile</label>
                        <select class="custom-select form-control shadow-sm" id="exhibitor_profile" name="exhibitor_profile">
                            @foreach($exhibitor_profiles as $exhibitor_profile)
                            <option value="{{$exhibitor_profile->epm_id}}" @if($exhibitor_profile->epm_id == $profileDetail->exhim_profile) selected @endif>{{$exhibitor_profile->epm_text}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6 col-6">
                    <div class="mb-4">
                        ...
                        <span><input type="text" class="form-control"  name="web_link" id="web_link" value="{{$profileDetail->exhim_web_link}}" /></span>
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <div class="mb-4">
                        <p class="text-primary mb-1">Facebook </p>
                        <span><input type="text" class="form-control"  name="facebook" id="facebook" value="{{$profileDetail->exhim_facebook_link}}" /></span>
                    </div>
                </div>
                 <div class="col-md-6 col-6">
                    <div class="mb-4">
                        <p class="text-primary mb-1">Youtube </p>
                        <span><input type="text" class="form-control"  name="youtube" id="youtube" value="{{$profileDetail->exhim_youtube_link}}" /></span>
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <div class="mb-4">
                        <p class="text-primary mb-1">Instagram </p>
                        <span><input type="text" class="form-control"  name="instagram" id="instagram" value="{{$profileDetail->exhim_instagram_link}}" /></span>
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <div class="mb-4">
                        <p class="text-primary mb-1">Twitter </p>
                        <span><input type="text" class="form-control"  name="twitter" id="twitter" value="{{$profileDetail->exhim_twitter_link}}" /></span>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-6">
                    <div class="mb-4">
                        ...
                        <span><input type="text" class="form-control"  name="linkedIn" id="linkedIn" value="{{$profileDetail->exhim_linkedIn_link}}" /></span>
                    </div>
                </div>
 ...
 <input class="form-control" type="hidden" name="quickfact" id="quickfact" value="quickfact" />
         <div class="row">
                ...
                <div class="col-md-12 col-12">
                    ...
                    <div class="mb-4 col-12">
                        ...
                        <span><input type="text" class="form-control"  name="punchline_text" id="punchline_text" value="{{$profileDetail->exhim_punchline}}" /></span>
                    </div>
          ...
          @elseif($reqData['ajaxRequset']=='standeeimg')
         ...
         <h4>Standee Image </h4>
                        <div class="row" style="border: 1px solid #e5e5e5;padding-top: 10px;border-radius: 27px;" >
                                   <div class="col-md-12">
                                        <div class="card mb-3">
                                          <!--<form class="" name="standeeform" action="saveuserprofile" method="post" enctype="multipart/form-data">-->
                                             ...
                                             <div class="col-md-12">
                                             <label>Booth: Standee Image ({{$reqData['width']}} X {{$reqData['height']}} px)</label>
                              ...
                              @elseif($reqData['ajaxRequset']=='standeeimg2')
                                   ...
                                   <div class="col-md-12">
                                        ...
                                        <div class="card mb-3">
                                          ...
                                          <!--</form>-->
                                             ...
                                             @elseif($reqData['ajaxRequset']=='standeeimg3')
         ...
         <h4>Standee Image 3 </h4>
                 ...
                 @elseif($reqData['ajaxRequset']=='standeeimg4')
         ...
         <h4>Standee Image 4 </h4>
                        <div class="row" style="border: 1px solid #e5e5e5;padding-top: 10px;border-radius: 27px;" >
                             ...
                             @elseif($reqData['ajaxRequset']=='desklogo')   
                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-3">
                                          <!--<form class="" name="desklogoForm" action="saveuserprofile" method="post" enctype="multipart/form-data">-->
                                                ...
                                                <div class="col-md-12">
                                                      <label>Booth: Desk-Logo  <em>({{$reqData['width']}} X {{$reqData['height']}} px)</em></label>
                                                      <div class="input-group mb-2">
                                                           
                                                          <input type="hidden" name="desklogo" id="desklogo" value="desklogo-1">
                                                          <input type="hidden" name="deskimage" id="deskimage" value="">
                                                          
                                                            <input type="hidden" name="ppm_id" id="ppm_id" value="{{$profileDetail->ppm_id}}">
                        ...
                        @elseif($reqData['ajaxRequset']=='backdrop-n-video')  
                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-3">
                                             ...
                                             <div class="col-md-12">
                                              ...
                                              <!--<input type="text" class="form-control" name="standeevideo_url" id="standeevideo_url" placeholder="Embed URL/Link of a Youtube Video." value="{{$profileDetail->exhim_stall_video}}" aria-label="video" >-->
