                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="text-primary">
                                                    <a href="https://megaspace.ai/<?php echo e($list->bm_nickname); ?>" title="View" target="_blank">
                                                        https://megaspace.ai/<?php echo e($list->bm_nickname); ?>
                                            ...
                                            <td><?php echo e($list->login_id); ?>
                                               ...
                                               <div>
                                                   <?php if(!empty($list->bm_nickname)): ?>
                                                   <span class="text-primary">https://megaspace.ai/admin/<?php echo e($list->bm_nickname); ?></span> 
                                                   <?php endif; ?>
                                               </div>
                                            </td>
...
<?php /**PATH /home/megaspace/public_html/admin/resources/views/superadmin/table_content.blade.php ENDPATH**/ ?>