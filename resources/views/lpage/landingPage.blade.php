                ...
                <div class="lgx-footer-area">
                    <div class="lgx-footer-single">
                        ...
                        <label for="logoFoo" onclick="CropperWH(200,219,'uploadlogoFoo','logoUpload','');">
                            @if(!empty($data[0]) && $data[0]->logo_foo_image != null)
                                <img src="{{asset($data[0]->logo_foo_image)}}" alt="Logo">
                            @else
                                <img src="{{asset('l_assets/img/footer-logo.png')}}" alt="Logo">
                            @endif
                        </label>
                    </div> <!--//footer-area-->
                    <div class="lgx-footer-single">
