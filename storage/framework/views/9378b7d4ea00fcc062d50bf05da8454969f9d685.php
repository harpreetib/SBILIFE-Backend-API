		    ...
		    <div class="card mb-4">
		        <div class="card-body">
		                ...
		                <div class="row">
		                    ...
		                    <!--<div class="col-md-6 form-group mb-3">-->
                      <!--                  <label for="course_fee_sem">Contact Person In-Charge</label>-->
                      <!--                  <input type="text" class="form-control"  name="ex_contact_person_incharge" id="ex_contact_person_incharge" placeholder="Contact Person In-Charge" value="<?php echo e($dataList->contact_person_incharge); ?>" />-->
                      <!--                  <span class="text-danger" id="msg_cpi" name="msg_cpi"  style="display:none;"></span>-->
                      <!--              </div>-->
		                    ...
		                    <div class="col-md-6 form-group mb-3">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <div class="col-md-12 form-group mb-3 d-none2">
                                        <h5 class="d-none2"><label class="font-weight-bold"># PROJECT TYPE</label></h5>
                                        <span class="text-danger" id="ed_msg_temp" name="ed_msg_temp"  style="display:none;"></span>
                                        <?php $__currentLoopData = $project_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="pt_ids[]" value="<?php echo e($list->pt_id); ?>"  <?php if(in_array($list->pt_id,explode(',',$dataList->pt_id))): ?> <?php echo e('checked'); ?> <?php endif; ?> >
                                            <label class="form-check-label" for="exampleCheck1"><?php echo e($list->pt_text); ?></label>
                                          </div>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
		      		...
		      		//consol.log('jhgjhgj');
					    ...
					    if(categoryID){
					        $.ajax({
					           ...
					           type:"POST",
					           url:"ex_subcategorylist/"+categoryID,
					   ...
					   $('#ex_multiselect2').multiselect({
				includeSelectAllOption: false,
				nonSelectedText: 'Nature Of Your Business?' });
		      </script>
              <?php /**PATH /home/megaspace/public_html/admin/resources/views/datatables/editexhibitor.blade.php ENDPATH**/ ?>