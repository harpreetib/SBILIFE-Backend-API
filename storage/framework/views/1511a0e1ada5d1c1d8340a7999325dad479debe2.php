        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('managestream')); ?>">Manage Stream</a>
                    <a class="dropdown-item" href="<?php echo e(route('packages')); ?>">Manage Packages</a>
                    <a class="dropdown-item" href="<?php echo e(route('templates')); ?>">Manage Templates</a>
...
<!-- header top menu end --><?php /**PATH /home/metagraha/public_html/induction_testing/admin/resources/views/layouts/large-vertical-sidebar/header.blade.php ENDPATH**/ ?>