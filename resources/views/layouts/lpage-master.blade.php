...
<div id="mySidebar" class="sidebar">
  ...
  <a href="landingPage?template={{base64_encode($td->tm_id)}}" onclick="selectTemp('{{$td->tm_id}}', '{{$selectedEvent->aem_id}}');" >{{$td->tm_name}}</a>
  @endforeach
</div>    
    
@yield('main-content')

@include('layouts.modal-lpage')
