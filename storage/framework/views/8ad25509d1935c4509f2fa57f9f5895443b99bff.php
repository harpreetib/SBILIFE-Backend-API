                            ...
                            <div class="lgx-banner-info"> <!--lgx-banner-info-center lgx-banner-info-black lgx-banner-info-big lgx-banner-info-bg-->
                                ...
                                <h2 class="title" id="baner_title" contentEditable="true">
                                    <?php if(!empty($data[0])): ?>
                                        ...
                                        <?php if(!empty($data[0]->baner_title)): ?>
...
<!--VIDEO-->
<section <?php echo e($videoSection); ?> >
...
<?php echo $__env->make('layouts.lpage-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibentosroot/public_html/events/admin/resources/views/lpage/landingPage2.blade.php ENDPATH**/ ?>