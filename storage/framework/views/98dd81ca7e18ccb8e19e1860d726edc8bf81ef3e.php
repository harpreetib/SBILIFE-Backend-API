<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item d-none <?php if(basename($_SERVER['REQUEST_URI'])=='prospects'): ?> active <?php endif; ?>" >
                <a class="nav-item-hold" href="<?php echo e(url('templates')); ?>">
                    <i class="nav-icon i-Administrator"></i>
...
<!--=============== Left side End ================--><?php /**PATH /home/metagraha/public_html/induction_testing/admin/resources/views/layouts/large-vertical-sidebar/sidebar.blade.php ENDPATH**/ ?>