            ...
            <div class="lgx-container"> <!--lgx-container-fluid-->
                <nav class="navbar navbar-default lgx-navbar">
                    <div class="navbar-header">
                        ...
                        <div class="lgx-logo">
                            <a href="#" class="lgx-scroll" contentEditable="true">
...
<!--BANNER-->
<section>
    <div class="lgx-banner lgx-banner3">
        <div class="lgx-banner-style">
            <div class="lgx-inner lgx-inner-fixed">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-7">
                            <div class="lgx-banner-info" contentEditable="true"> <!--lgx-banner-info-center lgx-banner-info-black lgx-banner-info-big lgx-banner-info-bg-->
                                <h3 class="subtitle" id="baner_subtitle">You learn Advance</h3>
                                <h2 class="title" id="baner_title">Festiva <span><b>2</b><b>0</b><b>2</b><b>2</b></span></h2>
                                <h3 class="date" id="baner_date"><i class="fa fa-calendar"></i> 23-27 September, 2022</h3>
                                <h3 class="location" id="baner_location"><i class="fa fa-map-marker"></i> 21 King Street, Dhaka 1205, Bangladesh.</h3>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="lgx-about-content-area">
                            <div class="lgx-heading">
                                <h2 class="heading">Happy New Year 2022</h2>
                                <h3 class="subheading">Why Happy New Year 2022 ?</h3>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="lgx-about-video">
                            <div class="lgx-video-area">
                                <figure>
                                    <a href="#"><img src="{{asset('l_assets/img/about-video-bg2.jpg')}}" alt="Event Video"></a>
                                    <figcaption>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-6 col-md-3">
                                                    <div class="lgx-counter-area">
                                                        <img src="{{asset('l_assets/img/icons/1.png')}}" alt="teacher icon">
                                                        <div class="counter-text">
                                                            <span class="lgx-counter">500</span>
                                                            <small>Usefull Sessions</small>
                                                        </div>
                                                    </div>
                                                </div> <!--//.COL-->
                                                <div class="col-xs-12 col-sm-6 col-md-3">
                                                    <div class="lgx-counter-area">
                                                        <img src="{{asset('l_assets/img/icons/2.png')}}" alt="teacher icon">
                                                        <div class="counter-text">
                                                            <span class="lgx-counter">085</span>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-3">
                                                    <div class="lgx-counter-area">
                                                        <img src="{{asset('l_assets/img/icons/3.png')}}" alt="teacher icon">
                                                        <div class="counter-text">
                                                            <span class="lgx-counter">7896</span>
                                                            <small>Regular Crowd</small>
                                                        </div>
                                                    </div>
                                                </div> <!--//.COL-->
                                                <div class="col-xs-12 col-sm-6 col-md-3">
                                                    <div class="lgx-counter-area">
                                                        <img src="{{asset('l_assets/img/icons/4.png')}}" alt="teacher icon">
                                                        <div class="counter-text">
                                                            <span class="lgx-counter">600</span>
                                                            <small>Skilled Speakers</small>
                                                        </div>
                                                    </div>
                                                </div> <!--//.COL-->
                                            </div> <!--//.ROW-->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-col4 lgx-single-speaker2">
                            <figure>
                                <a class="profile-img" href="speakers.html"><img src="{{asset('l_assets/img/speakers/speaker1.jpg')}}" alt="Speaker"/></a>
                                <figcaption>
                        ...
                        <div class="lgx-col4 lgx-single-speaker2">
                            <figure>
                                <a class="profile-img" href="speakers.html"><img src="{{asset('l_assets/img/speakers/speaker2.jpg')}}" alt="Speaker"/></a>
                                <figcaption>
                                    <div class="social-group">
                                        <a class="sp-tw" href="#"><i class="fa fa-twitter"></i></a>
                                        <a class="sp-fb" href="#"><i class="fa fa-facebook"></i></a>
                        ...
                        <div class="lgx-col4 lgx-single-speaker2">
                            <figure>
                                <a class="profile-img" href="speakers.html"><img src="{{asset('l_assets/img/speakers/speaker3.jpg')}}" alt="Speaker"/></a>
                                <figcaption>
                                    <div class="social-group">
                                        <a class="sp-tw" href="#"><i class="fa fa-twitter"></i></a>
                                        <a class="sp-fb" href="#"><i class="fa fa-facebook"></i></a>
                        ...
                        <div class="lgx-col4 lgx-single-speaker2">
                            <figure>
                                <a class="profile-img" href="speakers.html"><img src="{{asset('l_assets/img/speakers/speaker4.jpg')}}" alt="Speaker"/></a>
                                <figcaption>
                                    <div class="social-group">
                                        <a class="sp-tw" href="#"><i class="fa fa-twitter"></i></a>
                                        <a class="sp-fb" href="#"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-xs-12">
                        <div class="lgx-tab">
                            <ul class="nav nav-pills lgx-nav">
                                <li class="active"><a data-toggle="pill" href="#home"><h3>First <span>Day</span></h3> <p><span>29 </span>Nov, 2022</p></a></li>
                                                ...
                                                <div class="panel-title">
                                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <div class="lgx-single-schedule">
                                                            <div class="author">
                                                                <img src="{{asset('l_assets/img/speakers/speaker1.jpg')}}" alt="Speaker"/>
                                                            </div>
                                            ...
                                            <div class="panel-heading" role="tab" id="headingTwo">
                                                <div class="panel-title">
                                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                                        <div class="lgx-single-schedule">
                                                            <div class="author">
                                                                <img src="{{asset('l_assets/img/speakers/speaker2.jpg')}}" alt="Speaker"/>
                                                            </div>
                                                            <div class="schedule-info">
                                                    ...
                                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                                                        <div class="lgx-single-schedule">
                                                            <div class="author author-multi">
                                                                <img src="{{asset('l_assets/img/speakers/speaker1.jpg')}}" alt="Speaker"/>
                                                                <img src="{{asset('l_assets/img/speakers/speaker2.jpg')}}" alt="Speaker"/>
                                                                <img src="{{asset('l_assets/img/speakers/speaker3.jpg')}}" alt="Speaker"/>
                                                                <img src="{{asset('l_assets/img/speakers/speaker4.jpg')}}" alt="Speaker"/>
                                                            </div>
                                                            <div class="schedule-info">
                                                    ...
                                                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapsefour" aria-expanded="true" aria-controls="collapsefour">
                                                        <div class="lgx-single-schedule">
                                                            ...
                                                            <div class="schedule-info">
                                                                ...
                                                                <h3 class="title">Hungry Shawnee boys soccer team eyeing conference, sectional title in 2022</h3>
                                                                <h4 class="author-info">By <span>Joanna Smith</span> , Design Apple</h4>
                                                            </div>
                                                        </div>
                                                    </a>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="sponsors-area sponsors-area-bg">
                                <div class="single">
                                    <a class="" href="#"><img src="{{asset('l_assets/img/sponsors/sponsor1.png')}}" alt="sponsor"/></a>
                                </div>
                                <div class="single">
                                    <a class="" href="#"><img src="{{asset('l_assets/img/sponsors/sponsor2.png')}}" alt="sponsor"/></a>
                                </div>
                                <div class="single">
                                    <a class="" href="#"><img src="{{asset('l_assets/img/sponsors/sponsor3.png')}}" alt="sponsor"/></a>
                                </div>
                                <div class="single">
                                    <a class="" href="#"><img src="{{asset('l_assets/img/sponsors/sponsor4.png')}}" alt="sponsor"/></a>
                                </div>
                                <div class="single">
                                    <a class="" href="#"><img src="{{asset('l_assets/img/sponsors/sponsor1.png')}}" alt="sponsor"/></a>
                                </div>
...
#phg2:hover{
    ...
    <section>
        <div id="lgx-photo-gallery" class="lgx-gallery-popup lgx-photo-gallery-normal">
            <div class="lgx-inner">
                <div class="container">
                    <div class="row" id="phg" contenteditable="true">
                        <div class="col-xs-12">
                            <div class="lgx-heading">
                                <h2 class="heading">Photo Gallery</h2>
                                <h3 class="subheading">Welcome to the dedicated to building remarkable Sponsores!</h3>
                            </div>
                            <span class="tip mdi mdi-pencil" data-tip="Edit">Edit</span>
                            
                        </div>
                    </div>
                    <div class="row" id="phg2">
                        <div class="col-xs-12">
                            <div class="lgx-gallery-area">
                                <div  class="lgx-gallery-single">
                                     
                                     <span data-toggle="modal" data-target="#addquestionModal" class="btn btn-primary float-right">Add New gallery</span>
                                    <figure>
                                        <img title="Memories One" src="{{asset('l_assets/img/gallery/gallery2.jpg')}}" alt="Memories one"/>
                                        <figcaption class="lgx-figcaption">
                                            <div class="lgx-hover-link">
                                                <div class="lgx-vertical">
                                                    <a title="Memories One" href="{{asset('l_assets/img/gallery/gallery2.jpg')}}">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="#" class="btn btn-primary" onclick="savequestions();">Save changes</a>
      </div>
    </div>
  </div>
</div>
                                ...
                                <!--<div  class="lgx-gallery-single">-->
                                <!--    <figure>-->
                                <!--        <img src="{{asset('l_assets/img/gallery/gallery4.jpg')}}" alt="Memories Two" title="Memories Two" />-->
                                <!--        <figcaption class="lgx-figcaption">-->
                                <!--            <div class="lgx-hover-link">-->
                                <!--                <div class="lgx-vertical">-->
                                <!--                    <a title="Memories Two" href="{{asset('l_assets/img/gallery/gallery4.jpg')}}">-->
                                <!--                        <i class="fa fa-chain-broken" aria-hidden="true"></i>-->
                                <!--                    </a>-->
                                <!--                </div>-->
                                <!--            </div>-->
                                ...
                                <!--<div  class="lgx-gallery-single">-->
                                <!--    <figure>-->
                                <!--        <img src="{{asset('l_assets/img/gallery/gallery5.jpg')}}" alt="Memories Three" title="Memories Three" />-->
                                <!--        <figcaption class="lgx-figcaption">-->
                                <!--            <div class="lgx-hover-link">-->
                                <!--                <div class="lgx-vertical">-->
                                <!--                    <a title="Memories Three" href="{{asset('l_assets/img/gallery/gallery5.jpg')}}">-->
                                <!--                        <i class="fa fa-chain-broken" aria-hidden="true"></i>-->
                                <!--                    </a>-->
                                <!--                </div>-->
                                <!--            </div>-->
                                ...
                                <!--<div  class="lgx-gallery-single">-->
                                <!--    <figure>-->
                                <!--        <img src="{{asset('l_assets/img/gallery/gallery6.jpg')}}" alt="Memories Four" title="Memories Four" />-->
                                <!--        <figcaption class="lgx-figcaption">-->
                                <!--            <div class="lgx-hover-link">-->
                                <!--                <div class="lgx-vertical">-->
                                <!--                    <a title="Memories Four" href="{{asset('l_assets/img/gallery/gallery6.jpg')}}">-->
                                <!--                        <i class="fa fa-chain-broken" aria-hidden="true"></i>-->
                                <!--                    </a>-->
                                <!--                </div>-->
                                <!--            </div>-->
                                ...
                                <!--<div class="lgx-gallery-single">-->
                                <!--    <figure>-->
                                <!--        <img src="{{asset('l_assets/img/gallery/gallery2.jpg')}}" alt="Memories Five" title="Memories Five" />-->
                                <!--        <figcaption class="lgx-figcaption">-->
                                <!--            <div class="lgx-hover-link">-->
                                <!--                <div class="lgx-vertical">-->
                                <!--                    <a title="Memories Five" href="{{asset('l_assets/img/gallery/gallery2.jpg')}}">-->
                                <!--                        <i class="fa fa-chain-broken" aria-hidden="true"></i>-->
                                <!--                    </a>-->
                                <!--                </div>-->
                                <!--            </div>-->
                                ...
                                <!--<div class="lgx-gallery-single">-->
                                <!--    <figure>-->
                                <!--        <img src="{{asset('l_assets/img/gallery/gallery5.jpg')}}" alt="Memories Six" title="Memories Six" />-->
                                <!--        <figcaption class="lgx-figcaption">-->
                                <!--            <div class="lgx-hover-link">-->
                                <!--                <div class="lgx-vertical">-->
                                <!--                    <a title="Memories Six" href="{{asset('l_assets/img/gallery/gallery4.jpg')}}">-->
                                <!--                        <i class="fa fa-chain-broken" aria-hidden="true"></i>-->
                                <!--                    </a>-->
                                <!--                </div>-->
                                <!--            </div>-->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="lgx-single-news">
                                <figure>
                                    <a href="news-single.html"><img src="{{asset('l_assets/img/news/news1.jpg')}}" alt=""></a>
                                </figure>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="lgx-single-news">
                                <figure>
                                    <a href="news-single.html"><img src="{{asset('l_assets/img/news/news2.jpg')}}" alt=""></a>
                                </figure>
                                <div class="single-news-info">
                                    <div class="meta-wrapper">
                                        <span>April 25, 2022</span>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="lgx-single-news">
                                <figure>
                                    <a href="news-single.html"><img src="{{asset('l_assets/img/news/news3.jpg')}}" alt=""></a>
                                </figure>
                                <div class="single-news-info">
                                    <div class="meta-wrapper">
                                        <span>April 25, 2022</span>
            ...
            <div class="container">
                <div class="lgx-footer-area">
                    <div class="lgx-footer-single">
                        <a class="logo" href="#"><img src="{{asset('l_assets/img/footer-logo.png')}}" alt="Logo"></a>
                    </div> <!--//footer-area-->
                    <div class="lgx-footer-single">
...
<!-- JQUERY  -->
<script src="{{asset('l_assets/js/vendor/jquery-1.12.4.min.js')}}"></script>

<!-- BOOTSTRAP JS  -->
<script src="{{asset('l_assets/libs/bootstrap/js/bootstrap.min.js')}}"></script>

<!-- Smooth Scroll  -->
<script src="{{asset('l_assets/libs/jquery.smooth-scroll.js')}}"></script>

<!-- SKILLS SCRIPT  -->
<script src="{{asset('l_assets/libs/jquery.validate.js')}}"></script>
...
<!-- CUSTOM GOOGLE MAP -->
<script type="text/javascript" src="{{asset('l_assets/libs/gmap/jquery.googlemap.js')}}"></script>

<!-- adding magnific popup js library -->
<script type="text/javascript" src="{{asset('l_assets/libs/maginificpopup/jquery.magnific-popup.min.js')}}"></script>

<!-- Owl Carousel  -->
<script src="{{asset('l_assets/libs/owlcarousel/owl.carousel.min.js')}}"></script>

<!-- COUNTDOWN   -->
<script src="{{asset('l_assets/libs/countdown.js')}}"></script>
<script src="{{asset('l_assets/libs/timer/TimeCircles.js')}}"></script>

<!-- Counter JS -->
<script src="{{asset('l_assets/libs/waypoints.min.js')}}"></script>
<script src="{{asset('l_assets/libs/counterup/jquery.counterup.min.js')}}"></script>

<!-- SMOTH SCROLL -->
<script src="{{asset('l_assets/libs/jquery.smooth-scroll.min.js')}}"></script>
<script src="{{asset('l_assets/libs/jquery.easing.min.js')}}"></script>

<!-- type js -->
<script src="{{asset('l_assets/libs/typed/typed.min.js')}}"></script>

<!-- header parallax js -->
<script src="{{asset('l_assets/libs/header-parallax.js')}}"></script>

<!-- instafeed js -->

<script src="{{asset('l_assets/libs/instafeed.min.js')}}"></script>

<!-- CUSTOM SCRIPT  -->
<script src="{{asset('l_assets/js/custom.script.js')}}"></script>
