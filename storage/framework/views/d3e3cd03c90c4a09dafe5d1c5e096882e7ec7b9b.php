...
<?php $__env->startSection('main-content'); ?>
        ...
        <div class="breadcrumb">
                <h1>Selfie Wall</h1>
                <ul>
                  <li><a href="selfiewall">View List</a></li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="content">
                                <p class="text-muted mt-2 mb-0">Total Selfie</p>
                                <p class="text-primary text-24 line-height-1 mb-2"><?php echo e($TotalSelfieUploaded); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="card-title">Selfie Data</div>
                             <div class="panel-body" align="center">
                                 ...
                                 <div id="tabledata" class="table-responsive" style="min-height: 359px;">
                                         <table id="user_table" class="table table-bordered  text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($i++); ?></td>
                                                    <td><?php echo e($list->lm_fullname); ?></td>
                                                    <td><?php echo e($list->lm_email); ?></td>
                                                    <td>
                                                        <img src="<?php echo e(asset($list->selfie_url)); ?>" height="100" width="200"/>
                                                    </td>
                                                    <td><?php echo e(date('Y-m-d H:i:s',strtotime($list->sf_insert_time))); ?></td>
                                                    <td>
                                                        <a href="<?php echo e(asset($list->selfie_url)); ?>" class="btn btn-outline-success" target="_blank" >View</button>
                                                    </td>
                                                </tr>
                                  ...
                                  <div class="col-md-12">
                                    <!--<div class="col-md-6  text-left"><?php echo e($leadlist->onEachSide(2)->appends(request()->except('page'))->links()); ?></div>-->
                              ...
                              <p class="float-left">
                                Displaying <?php echo e($leadlist->count()); ?> of <?php echo e($leadlist->total()); ?> selfie(s).
                            </p>
                                  </div>
                                </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megaspace/public_html/admin/resources/views/customers/selfie-wall/index.blade.php ENDPATH**/ ?>