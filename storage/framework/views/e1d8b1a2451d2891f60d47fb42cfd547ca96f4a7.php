            ...
            <div class="card mb-4">
                <div class="card-body">          
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group mb-3 ml-2">
                                <span><?php echo e($list->etm_name); ?></span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/metagraha/public_html/induction/admin/resources/views/manage_templates/index.blade.php ENDPATH**/ ?>