                    ...
                    <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="content">
                                ...
                                <p class="text-primary text-24 line-height-1 mb-2">{{$TotalSelfieUploaded}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-title">Selfie Data</div>
                             <div class="panel-body" align="center">
                                 ...
                                 <div id="tabledata" class="table-responsive" style="min-height: 359px;">
                                         <table id="user_table" class="table table-bordered  text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$list->lm_email}}</td>
                                                    <td>
                                                        <img src="{{asset($list->selfie_url)}}" height="100" width="200"/>
                                                    </td>
                                                    <td>{{date('Y-m-d H:i:s',strtotime($list->sf_insert_time))}}</td>
                                                    <td>
                                                        <a href="{{asset($list->selfie_url)}}" class="btn btn-outline-success" target="_blank" >View</button>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                  ...
                                  <div class="col-md-12">
                                    <!--<div class="col-md-6  text-left">{{$leadlist->onEachSide(2)->appends(request()->except('page'))->links()}}</div>-->
                              ...
                              <p class="float-left">
                                Displaying {{$leadlist->count()}} of {{ $leadlist->total() }} selfie(s).
                            </p>
                                  </div>
                                </div>
                        </div>
