                        ...
                        <tr>
                            <td style="padding:30px 15px; font-family:Times New Roman, Georgia, Serif;">
                                <h1
                                    ...
                                    Dear <?php echo e($booth_name); ?>,
                                </h1>
                                
                                <p>You have received an enquiry. Here are the contact details of the user.</br><br/>
                                <br>
                                Name: <?php echo e($enquiryData['ind_fullname']); ?><br/>
                                Email : <?php echo e($enquiryData['ind_email']); ?><br/>
                                Designation: <?php echo e($enquiryData['ind_designation']); ?><br/>
                                Company: <?php echo e($enquiryData['ind_company_name']); ?><br/>
                                Message: <?php echo e($enquiryData['ind_message']); ?></br>
                                
                                <br><br>
                                You may contact him/her for further assistance. <a href="<?php echo e($uniquelink); ?>" target="_blank">Click here to reply</a>
                                <br><br>
...
</html><?php /**PATH /home/megaspace/public_html/admin/resources/views/emailer/contact_us_mail.blade.php ENDPATH**/ ?>