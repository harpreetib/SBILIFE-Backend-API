                    ...
                    <div class="navbar-header">
                        ...
                        <div class="lgx-logo">
                            ...
                            <label for="logo" onclick="CropperWH(160,81,'uploadlogo','logoUpload','');">
                                ...
                                <?php if(!empty($data[0]) && $data[0]->logo_image != null): ?>
                                    <img src="<?php echo e(asset($data[0]->logo_image)); ?>" alt="Emeet Logo"/>
                                <?php else: ?>
                                    <img src="<?php echo e(asset('l_assets/img/logo.png')); ?>" alt="Emeet Logo"/>
                                <?php endif; ?>
...
<!--HEADER END--><?php /**PATH /home/ibentosroot/public_html/events/admin/resources/views/layouts/header-lpage.blade.php ENDPATH**/ ?>