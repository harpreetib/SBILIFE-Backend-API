		...
		<form  name="editexhibitor" id="editexhibitor" action="addEventLaunch" method="post" enctype="multipart/form-data">
		 <?php echo e(csrf_field()); ?>
    	                ...
    	                <div class="row">
    	                    <div class="col-md-12 form-group mb-3">
    	                        <select class="custom-select" id="elm_active_url" name="elm_active_url" onchange="ChangeActiveUrl(this.value)">
                                    ...
                                    <option value="youtube" <?php if($dataList->elm_active_url=='youtube'): ?> selected  <?php endif; ?> >Youtube</option>
                                    <option value="daily-co" <?php if($dataList->elm_active_url=='daily-co'): ?> selected  <?php endif; ?> >Daily-co</option>
                                </select>
    	                    </div>
                            ...
                            <div class="col-md-12 form-group mb-3 youtube-div" style="<?=$dataList->elm_active_url!='youtube' ? 'display:none':''?>">
                                ...
                                <input type="text" class="form-control" name="elm_youtube_url" id="elm_youtube_url" placeholder="Youtube embed url" 
                                 value="<?php echo e(isset($dataList->elm_youtube_url) ? $dataList->elm_youtube_url : ''); ?>">
                            </div>
                            ...
                            <div class="col-md-12 form-group mb-3 dailyco-div" style="<?=$dataList->elm_active_url!='daily-co' ? 'display:none':''?>">
                                ...
                                <input type="text" class="form-control" disabled name="elm_daily_co_name" id="elm_daily_co_name" value="<?php echo e(isset($dataList->elm_daily_co_name) ? $dataList->elm_daily_co_name : ''); ?>" placeholder="Enter Daily-Co Meeting Name">
                            </div>
                            ...
                            <div class="col-md-12 form-group mb-3 dailyco-div" style="<?=$dataList->elm_active_url!='daily-co' ? 'display:none':''?>">
                                ...
                                <input type="text" class="form-control" disabled name="elm_daily_co_url" id="elm_daily_co_url" placeholder="Daily-Co url" 
                                 value="<?php echo e(isset($dataList->elm_daily_co_url) ? $dataList->elm_daily_co_url : ''); ?>">
                            </div>
	        ...
	        <div class="modal-footer">
	             <input type="hidden" class="form-control" value="<?php echo e(isset($dataList->elm_id)?$dataList->elm_id:''); ?>" name="elm_id" id="elm_id">
	             <input type="hidden" class="form-control" value="<?php echo e($elId); ?>" name="el_id" id="el_id">
    ...
    </script><?php /**PATH /home/megaspace/public_html/admin/resources/views/customers/manage-events/edit_event_launch.blade.php ENDPATH**/ ?>