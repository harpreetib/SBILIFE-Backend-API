...
@foreach($leadList as $list)
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                                {{ucfirst($list->lm_fullname)}}
                                                <div class="divide">{{$list->lm_email}} </div>
                                                <div class="divide">{{$list->lm_mobile}}
                                          </td>
                                          ...
                                          <td> 
                                                @if(Session::has('profileDetail') && in_array(Session::get('profileDetail')->at_id, array('4','3','8')))
                                                ...
                                                @endif
                                                @if(strpos($list->activity,'Send Quotation')==true)
                                                <span class="btn p-1 m-0" onclick="showQuotation('{{$list->lm_mobile}}','{{$list->lm_email}}');" > / View Quotation</span>
                                                @endif
                                           ...
                                           <td>
                                                                                                    <!--<a href="javascript:void(0);" onclick="whatsappCall(this, `{{Session::get('session')[0]->exhim_id}}`);" data-id="+{{$list->lm_country_code}}{{$list->lm_mobile}}" data-link="{{ config('app.siteBaseUrl') }}/{{Session::get('selectedEvent')->aem_event_nickname}}.php?reg={{base64_encode($list->lemmid)}}&univsty={{base64_encode($profileDetail->exhim_id)}}" data-text="{{$list->lm_fullname}}">-->
