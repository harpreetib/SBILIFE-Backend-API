                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-7">
                            <div class="lgx-banner-info"> <!--lgx-banner-info-center lgx-banner-info-black lgx-banner-info-big lgx-banner-info-bg-->
                                <h3 class="subtitle">You learn Advance</h3>
                                <h2 class="title">Festiva <span><b>2</b><b>0</b><b>2</b><b>2</b></span></h2>
                                <h3 class="date"><i class="fa fa-calendar"></i> 23-27 September, 2022</h3>
                                <h3 class="location"><i class="fa fa-map-marker"></i> 21 King Street, Dhaka 1205, Bangladesh.</h3>
                                <div class="action-area">
                                    <div class="lgx-video-area">
                                        <a class="lgx-btn lgx-btn-red" href="#">Contact</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$( document ).ready(function() {
    $(".heading").click(function(){
          var head= $(".heading").html();
        alert(head);
        var shead= $(".subheading").html();
        alert(shead);
    });
});
...
<script>
    ...
    console.log("ok");
    var route ='{{URL::to('/')}}/ibentos/Addcms';
                              $.ajax({
                                  headers: {
...
// function editeventdetails(cms_id){
// //    alert(cms_id);
